export default function SolarSystem() {
  const planets = [
    {
      ...
      animate: "animate-[spin_7s_ease-in-out_infinite]",
    },
    {
      width: "w-[30vw]",
      height: "h-[30vw]",
      planetWidth: "w-[15px] h-[15px]",
      animate: "animate-[spin_8s_ease-in-out_infinite]",
    },
    {
      width: "w-[40vw]",
      height: "h-[40vw]",
  ...
  return (
    <div className="opacity-30">
      <div className="absolute h-screen w-screen top-80 flex justify-center items-center">
        <div className="w-[8vw] h-[8vw] rounded-full bg-yellow-300"></div>
      </div>
      {planets.map(({ width, height, top, left, planetWidth, animate }, i) => (
        <div
          key={i}
          className="absolute h-screen w-screen top-80 flex justify-center items-center"
        >
          <div
